...
class CreateAutoInventoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('auto_inventory', function (Blueprint $table) {
            ...
            $table->boolean('flag_transfer')->default(1);
    ...
    {
        Schema::dropIfExists('auto_inventory');
    }
}
