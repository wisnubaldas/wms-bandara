...
class CreateTdOutbondDeliveryStagingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('td_outbond_delivery_staging', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('td_outbond_delivery_staging');
    }
}
