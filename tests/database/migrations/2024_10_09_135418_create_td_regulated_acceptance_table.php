...
class CreateTdRegulatedAcceptanceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('td_regulated_acceptance', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('td_regulated_acceptance');
    }
}
