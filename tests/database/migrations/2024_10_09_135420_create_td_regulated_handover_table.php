...
class CreateTdRegulatedHandoverTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('td_regulated_handover', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('td_regulated_handover');
    }
}
