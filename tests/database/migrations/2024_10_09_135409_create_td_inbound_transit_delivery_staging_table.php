...
class CreateTdInboundTransitDeliveryStagingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('td_inbound_transit_delivery_staging', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('td_inbound_transit_delivery_staging');
    }
}
