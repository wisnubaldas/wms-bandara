...
class CreateTdRegulatedWeighingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('td_regulated_weighing', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('td_regulated_weighing');
    }
}
