...
class CreateTdInboundBreakdownTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('td_inbound_breakdown', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('td_inbound_breakdown');
    }
}
