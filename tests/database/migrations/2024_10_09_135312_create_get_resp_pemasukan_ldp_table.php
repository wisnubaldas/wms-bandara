...
class CreateGetRespPemasukanLdpTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('get_resp_pemasukan_ldp', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('get_resp_pemasukan_ldp');
    }
}
