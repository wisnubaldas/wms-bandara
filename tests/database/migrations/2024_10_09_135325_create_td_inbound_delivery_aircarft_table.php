...
class CreateTdInboundDeliveryAircarftTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('td_inbound_delivery_aircarft', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('td_inbound_delivery_aircarft');
    }
}
