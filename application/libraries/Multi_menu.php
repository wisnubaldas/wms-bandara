...
class Multi_menu {
	 ...
	 * @var string
	 */
	private $parent_anchor            = '<a href="%s">%s<span class="pull-right-container"><i class="fas fa-angle-left pull-right"></i></span></a>';
	 ...
	 * @var string
	 */
	private $item_anchor              = '<a href="%s"> <strong>%s</strong></a>';
