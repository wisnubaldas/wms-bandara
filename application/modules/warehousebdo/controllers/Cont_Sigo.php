...
class Cont_Sigo extends MX_Controller 
{
	...
	public  function get_inc_header($token,$Invoicenumber)
	{
		$listhasil = $this->sigo_model->inc_header($token,$Invoicenumber);
	...
	public  function get_inc_detail($token,$Invoicenumber)
	{
		$listhasil = $this->sigo_model->inc_detail($token,$Invoicenumber);
		// menjadikan objek menjadi JSON
		$hasil = json_encode($listhasil);
	...
	public  function get_out_header($token,$Invoicenumber)
	{
		$listhasil = $this->sigo_model->out_header($token,$Invoicenumber);
		// menjadikan objek menjadi JSON
		$hasil = json_encode($listhasil);
	...
	public  function get_out_detail($token,$Invoicenumber)
	{
		$listhasil = $this->sigo_model->out_detail($token,$Invoicenumber);
		// menjadikan objek menjadi JSON
		$hasil = json_encode($listhasil);
