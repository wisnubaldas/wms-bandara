...
class Cont_finance extends MX_Controller 
{
	...
	public function get_drsc_incoming($shifname,$dateDRSC,$PaymentCode,$token)
	{
		$listhasil = $this->finance_model->drsc_incoming($shifname,$dateDRSC,$PaymentCode,$token);
		// menjadikan objek menjadi JSON
		$hasil = json_encode($listhasil);
	...
	public function get_drsc_outgoing($shifname,$dateDRSC,$PaymentCode,$token)
	{
		$listhasil = $this->finance_model->drsc_outgoing($shifname,$dateDRSC,$PaymentCode,$token);
		// menjadikan objek menjadi JSON
		$hasil = json_encode($listhasil);
