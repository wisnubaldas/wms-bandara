...
class Finance_model extends CI_Model
{
	...
	public function drsc_incoming($shifname,$dateDRSC,$PaymentCode,$token)
	{
		$query=$this->db7->query("CALL Get_drsc_incoming('".$shifname."','".$dateDRSC."','".$PaymentCode."','".$token."');");
		return $query->result();
	}
	
	public function drsc_outgoing($shifname,$dateDRSC,$PaymentCode,$token)
	{
		$query=$this->db7->query("CALL Get_drsc_outgoing('".$shifname."','".$dateDRSC."','".$PaymentCode."','".$token."');");
		return $query->result();
	}
