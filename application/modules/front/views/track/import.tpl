      ...
      <div class="box box-import">
        <div class="box-header with-border bg-info">
          <h3 class="box-title">Import Tracking</h3>
...
<!-- Data table  -->
<div class="box grid-import" style="display: none;">
      ...
      <div class="info-box bg-aqua" style="min-height: 50px; margin-bottom: 0px;">
        <span class="info-box-icon" style="height: 50px;width: 50px;font-size: 33px;line-height: 50px;">
          <i class="far fa-plus-square"></i>
            ...
            <div class="info-box-content" style="padding: 0px 0px;margin-left: 60px;">
                <span class="info-box-text">Total Breakdown</span>
...
<script type="text/javascript">
  ...
  $(function(){
    var uriImport = "{base_url('front/trackController/import')}"
    {literal}
    $('[data-toggle="tooltip"]').tooltip(); 
    // show hiden grid 
    $('#back').click(function(){
      $('.box-import').toggle("slow", function(){
               $('#grid-data').DataTable().destroy()
                // console.log('another toggle div')
                $('.grid-import').toggle('slow');
            });
    })
      ...
      e.preventDefault()
        ...
        .done(function(a) {
          ...
          a.forEach( function(e, i) {
            ...
            if(e.STATUS === 'BREAKDOWN'){++totBook;}
            if(e.STATUS === 'DELIVERY'){++totWeigh;}
