...
class LocalMasterController extends MX_Controller
{
	...
	public function get_list_route($airlinescode,$flightno)
	{
		$listdata = $this->Sysmaster_model->list_route($airlinescode,$flightno);	
	...
	public function get_list_Nama_angkut($airlinescode=null)
	{
		$listdata = $this->Sysmaster_model->list_Nama_angkut($airlinescode);		
		// menjadikan objek menjadi JSON
		$data = json_encode($listdata);
		// mengeluarkan JSON ke browser
        header('HTTP/1.1: 200');
