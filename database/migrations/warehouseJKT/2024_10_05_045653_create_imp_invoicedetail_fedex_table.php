...
class CreateImpInvoicedetailFedexTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('imp_invoicedetail_fedex', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('imp_invoicedetail_fedex');
    }
}
