...
class CreateImpLocationMps2019Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('imp_location_mps_2019', function (Blueprint $table) {
            $table->bigInteger('noid')->default(0)->primary();
    ...
    {
        Schema::dropIfExists('imp_location_mps_2019');
    }
}
