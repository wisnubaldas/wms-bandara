...
class CreateSigoImpInvoicedetailCopyBelumEditTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sigo_imp_invoicedetail_copy_belum_edit', function (Blueprint $table) {
            ...
            $table->decimal('AirportContriFee', 15, 2)->default(0.00);
    ...
    {
        Schema::dropIfExists('sigo_imp_invoicedetail_copy_belum_edit');
    }
}
