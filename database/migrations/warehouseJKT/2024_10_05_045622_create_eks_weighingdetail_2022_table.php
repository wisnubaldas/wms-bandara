...
class CreateEksWeighingdetail2022Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eks_weighingdetail_2022', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('eks_weighingdetail_2022');
    }
}
