...
class CreateSigoImpInvoiceheaderTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sigo_imp_invoiceheader', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sigo_imp_invoiceheader');
    }
}
