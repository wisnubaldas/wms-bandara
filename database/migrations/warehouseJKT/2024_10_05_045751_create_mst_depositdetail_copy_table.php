...
class CreateMstDepositdetailCopyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mst_depositdetail_copy', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mst_depositdetail_copy');
    }
}
