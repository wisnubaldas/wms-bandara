...
class CreateSigoImpInvoicedetailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sigo_imp_invoicedetail', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sigo_imp_invoicedetail');
    }
}
