...
class CreateEksWeighingheader2023Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eks_weighingheader_2023', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('eks_weighingheader_2023');
    }
}
