...
class CreateMstTaxCopy032022Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mst_tax_copy_03_2022', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mst_tax_copy_03_2022');
    }
}
