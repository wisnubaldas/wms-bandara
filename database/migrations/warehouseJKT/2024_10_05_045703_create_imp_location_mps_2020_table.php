...
class CreateImpLocationMps2020Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('imp_location_mps_2020', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('imp_location_mps_2020');
    }
}
