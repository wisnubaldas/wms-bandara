...
class CreateImpInvoicedetailCopy2Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('imp_invoicedetail_copy2', function (Blueprint $table) {
            ...
            $table->decimal('pecahpos', 15, 2)->nullable();
    ...
    {
        Schema::dropIfExists('imp_invoicedetail_copy2');
    }
}
