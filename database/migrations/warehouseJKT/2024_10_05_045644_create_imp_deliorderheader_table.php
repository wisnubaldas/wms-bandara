...
class CreateImpDeliorderheaderTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('imp_deliorderheader', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('imp_deliorderheader');
    }
}
