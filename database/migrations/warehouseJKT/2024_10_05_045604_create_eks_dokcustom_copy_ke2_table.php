...
class CreateEksDokcustomCopyKe2Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eks_dokcustom_copy_ke2', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('eks_dokcustom_copy_ke2');
    }
}
