...
class CreateImpInvoiceheaderFedexTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('imp_invoiceheader_fedex', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('imp_invoiceheader_fedex');
    }
}
