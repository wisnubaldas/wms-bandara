...
class CreateImpHostawbCopy2022Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('imp_hostawb_copy_2022', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('imp_hostawb_copy_2022');
    }
}
