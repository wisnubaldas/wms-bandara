...
class CreateXinventoryHawbTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('xinventory_hawb', function (Blueprint $table) {
            ...
            $table->string('Origin', 6)->nullable();
    ...
    {
        Schema::dropIfExists('xinventory_hawb');
    }
}
