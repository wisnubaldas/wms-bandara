...
class CreateEksWeighingheader2022Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eks_weighingheader_2022', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('eks_weighingheader_2022');
    }
}
