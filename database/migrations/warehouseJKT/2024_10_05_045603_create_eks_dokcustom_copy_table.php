...
class CreateEksDokcustomCopyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropIfExists('eks_dokcustom_copy');
    }
}
