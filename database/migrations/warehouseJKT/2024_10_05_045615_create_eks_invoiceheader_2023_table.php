...
class CreateEksInvoiceheader2023Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eks_invoiceheader_2023', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('eks_invoiceheader_2023');
    }
}
