...
class CreateEksInvoicedetail2022Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eks_invoicedetail_2022', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('eks_invoicedetail_2022');
    }
}
