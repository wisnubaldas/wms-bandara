...
class CreateIncCargodemageTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inc_cargodemage', function (Blueprint $table) {
            ...
            $table->float('ActualWeight')->nullable();
            $table->string('DateOfIssue', 10)->nullable();
            $table->string('TimeOfIssue', 5)->nullable();
    ...
    {
        Schema::dropIfExists('inc_cargodemage');
    }
}
