...
class CreateImpInvoicedetail2021Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('imp_invoicedetail_2021', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('imp_invoicedetail_2021');
    }
}
