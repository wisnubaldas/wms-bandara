...
class CreateEksHostawbCopyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eks_hostawb_copy', function (Blueprint $table) {
            ...
            $table->string('PENnumber', 20)->nullable();
    ...
    {
        Schema::dropIfExists('eks_hostawb_copy');
    }
}
