...
class CreateImpDeliorderdetailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('imp_deliorderdetail', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('imp_deliorderdetail');
    }
}
