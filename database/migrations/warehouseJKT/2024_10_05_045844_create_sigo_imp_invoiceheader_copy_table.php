...
class CreateSigoImpInvoiceheaderCopyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropIfExists('sigo_imp_invoiceheader_copy');
    }
}
