...
class CreateGetsppbRushHandlingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('getsppb_rush_handling', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('getsppb_rush_handling');
    }
}
