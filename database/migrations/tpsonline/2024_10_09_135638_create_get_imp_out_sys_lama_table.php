...
class CreateGetImpOutSysLamaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('get_imp_out_sys_lama', function (Blueprint $table) {
            ...
            $table->string('no_master_bl_awb', 30)->default(' ');
    ...
    {
        Schema::dropIfExists('get_imp_out_sys_lama');
    }
}
