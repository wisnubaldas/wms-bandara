...
class CreateTdOutbondAcceptanceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('td_outbond_acceptance', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('td_outbond_acceptance');
    }
}
