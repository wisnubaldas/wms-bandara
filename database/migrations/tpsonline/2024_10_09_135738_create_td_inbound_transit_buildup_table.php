...
class CreateTdInboundTransitBuildupTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('td_inbound_transit_buildup', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('td_inbound_transit_buildup');
    }
}
