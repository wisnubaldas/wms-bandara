...
class CreateTdRegulatedScreeningTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('td_regulated_screening', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('td_regulated_screening');
    }
}
