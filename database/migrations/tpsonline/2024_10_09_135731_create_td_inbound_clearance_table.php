...
class CreateTdInboundClearanceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('td_inbound_clearance', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('td_inbound_clearance');
    }
}
