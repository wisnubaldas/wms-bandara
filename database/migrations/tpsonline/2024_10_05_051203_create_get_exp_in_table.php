...
class CreateGetExpInTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('get_exp_in', function (Blueprint $table) {
            ...
            $table->string('seri_kem', 5)->default('1');
            ...
            $table->string('no_dok_inout', 35)->nullable();
            ...
            $table->dateTime('date_update')->default('current_timestamp()');
            $table->boolean('flag_gateout')->default(0);
            $table->text('respon')->nullable();
            $table->string('token', 5)->nullable();
            $table->enum('Manual', ['YES', 'NO'])->default('NO');
        });
    }
    ...
    {
        Schema::dropIfExists('get_exp_in');
    }
}
