...
class CreateTdRegulatedStorageTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('td_regulated_storage', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('td_regulated_storage');
    }
}
