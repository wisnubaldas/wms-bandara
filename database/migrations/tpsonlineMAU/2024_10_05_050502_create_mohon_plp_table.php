...
class CreateMohonPlpTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mohon_plp', function (Blueprint $table) {
            ...
            $table->string('no_surat', 40)->index('no_surat');
