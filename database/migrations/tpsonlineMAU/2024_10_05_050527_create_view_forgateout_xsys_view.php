...
class CreateViewForgateoutXsysView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        return <<<'SQL'
            DROP VIEW IF EXISTS `view_forgateout_xsys`;
        SQL;
    }
}
