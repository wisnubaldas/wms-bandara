...
class CreateSendingFhl8ChargedeclarationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sending_fhl_8_chargedeclarations', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sending_fhl_8_chargedeclarations');
    }
}
