...
class CreateReceiveFhl2MasterawbconsignmentdetailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('receive_fhl_2_masterawbconsignmentdetail', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('receive_fhl_2_masterawbconsignmentdetail');
    }
}
