...
class CreateSendingFwb3FlightbookingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sending_fwb_3_flightbookings', function (Blueprint $table) {
            $table->bigInteger('id');
    ...
    {
        Schema::dropIfExists('sending_fwb_3_flightbookings');
    }
}
