...
class CreateSendingFwb5ShipperTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sending_fwb_5_shipper', function (Blueprint $table) {
            $table->bigInteger('id');
            ...
            $table->string('StreetAddress', 150)->nullable();
    ...
    {
        Schema::dropIfExists('sending_fwb_5_shipper');
    }
}
