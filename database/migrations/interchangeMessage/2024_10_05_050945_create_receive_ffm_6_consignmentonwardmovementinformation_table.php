...
class CreateReceiveFfm6ConsignmentonwardmovementinformationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('receive_ffm_6_consignmentonwardmovementinformation', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('receive_ffm_6_consignmentonwardmovementinformation');
    }
}
