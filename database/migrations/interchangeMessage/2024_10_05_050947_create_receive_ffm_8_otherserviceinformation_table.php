...
class CreateReceiveFfm8OtherserviceinformationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('receive_ffm_8_otherserviceinformation', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('receive_ffm_8_otherserviceinformation');
    }
}
