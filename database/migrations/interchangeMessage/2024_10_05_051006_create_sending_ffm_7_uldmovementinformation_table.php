...
class CreateSendingFfm7UldmovementinformationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sending_ffm_7_uldmovementinformation', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sending_ffm_7_uldmovementinformation');
    }
}
