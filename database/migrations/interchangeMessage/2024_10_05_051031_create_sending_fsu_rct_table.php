...
class CreateSendingFsuRctTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sending_fsu_rct', function (Blueprint $table) {
            ...
            $table->string('CarrierCodeOfTransferringCarrier', 2)->nullable();
    ...
    {
        Schema::dropIfExists('sending_fsu_rct');
    }
}
