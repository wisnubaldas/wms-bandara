...
class CreateSendingFhl6ShippernameandaddressTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sending_fhl_6_shippernameandaddress', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sending_fhl_6_shippernameandaddress');
    }
}
