...
class CreateSendingFwbFCollectchargesummaryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sending_fwb_f_collectchargesummary', function (Blueprint $table) {
            $table->bigInteger('id');
    ...
    {
        Schema::dropIfExists('sending_fwb_f_collectchargesummary');
    }
}
