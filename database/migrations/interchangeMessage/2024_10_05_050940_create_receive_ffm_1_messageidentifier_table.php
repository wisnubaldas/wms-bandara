...
class CreateReceiveFfm1MessageidentifierTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('receive_ffm_1_messageidentifier', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('receive_ffm_1_messageidentifier');
    }
}
