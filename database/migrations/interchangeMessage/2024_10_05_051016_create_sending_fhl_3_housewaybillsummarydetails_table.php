...
class CreateSendingFhl3HousewaybillsummarydetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sending_fhl_3_housewaybillsummarydetails', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sending_fhl_3_housewaybillsummarydetails');
    }
}
