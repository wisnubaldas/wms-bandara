...
class CreateSendingFhl4FreetextdescriptionofgoodsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sending_fhl_4_freetextdescriptionofgoods', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sending_fhl_4_freetextdescriptionofgoods');
    }
}
