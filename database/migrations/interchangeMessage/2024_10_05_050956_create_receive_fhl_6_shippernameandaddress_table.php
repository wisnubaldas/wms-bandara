...
class CreateReceiveFhl6ShippernameandaddressTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('receive_fhl_6_shippernameandaddress', function (Blueprint $table) {
            $table->bigInteger('id');
    ...
    {
        Schema::dropIfExists('receive_fhl_6_shippernameandaddress');
    }
}
