...
class CreateSendingFwbDOtherchargesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sending_fwb_d_othercharges', function (Blueprint $table) {
            $table->bigInteger('id');
            ...
            $table->string('OtherChargeCode', 2)->nullable();
    ...
    {
        Schema::dropIfExists('sending_fwb_d_othercharges');
    }
}
