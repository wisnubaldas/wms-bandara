...
class CreateSendingFhl7ConsigneenameandaddressTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sending_fhl_7_consigneenameandaddress', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sending_fhl_7_consigneenameandaddress');
    }
}
