...
class CreateSendingFwb9AlsonotifyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sending_fwb_9_alsonotify', function (Blueprint $table) {
            $table->bigInteger('id');
    ...
    {
        Schema::dropIfExists('sending_fwb_9_alsonotify');
    }
}
